<script lang="ts">
  ...
  import { createFocusManager } from "#youtube/components/download-options-panel/DownloadOptionsPanel.focus.svelte";
  import {
    HEADER_CLOSE_BUTTON_ID,
    sendPanelClosed
  } from "#youtube/components/download-options-panel/DownloadOptionsPanel.handlers.ts";
  import { attachCloseButton } from "#youtube/lib/ui/panel-button-attachments.svelte";
