<script lang="ts">
  ...
  import {
    createFooterState,
    PrimaryButtonState
  } from "#youtube/components/download-options-panel/DownloadOptionsPanelFooter.svelte.ts";
  import { attachViewButton } from "#youtube/lib/ui/panel-button-attachments.svelte";
