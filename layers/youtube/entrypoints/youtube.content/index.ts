...
import { initCompletedDownloadsStore } from "#youtube/lib/ui/completed-downloads-store.svelte";
import { forwardSabrCredentialsWithRetry, listenForSabrBodyReady } from "#youtube/lib/youtube/sabr/credentials";
