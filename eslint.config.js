...
export default [
  ...
  globalIgnores(["build/**", "node_modules/**", ".output/**", ".wxt/**", ".verify-output/**", "User Data/**", "user-profiles/**", "patches/**", "scripts/firefox-*.ts", "scripts/**", "layers/processing/entrypoints/mux-worker/opfs.d.ts", ".claude/worktrees/**"]),
  {
    files: ["**/*.{ts,js,mjs}"],
    languageOptions: {
  ...
  {
    files: ["**/layers/background/main.ts"],
    rules: {
      "no-void": "off"
    }
  }
